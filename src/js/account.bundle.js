...
(function () {
  ...
  1: [function (require, module, exports) {
    (function (global, factory) {
      _typeof(exports) === 'object' && typeof module !== 'undefined' ? module.exports = factory(function () {
        try {
  ...
  3: [function (require, module, exports) {
    var createChart = require('./chart.js');
    ...
    window.addEventListener('load', function () {
        ...
        request.onload = function () {
          ...
          if (!user.height) {
            ...
            if (user.weightDifference != 0 && user.weightDifference !== undefined) {
              var day;
              var dateString = String(user.dateDifference);
              var lastNumber = dateString[dateString.length - 1];
              ...
              message.innerHTML = "\u0412\u0430\u0448 \u043F\u0440\u043E\u0433\u0440\u0435\u0441\u0441: ".concat(user.weightDifference, " \u043A\u0433 \u0437\u0430 ").concat(user.dateDifference, " ").concat(day, ".");
            } else {
      ...
      startForm.addEventListener('submit', function (e) {
        e.preventDefault();
        var id = getCookie('userId');
        var heightValue = startForm.querySelector('#height-value'),
      ...
      updateForm.addEventListener('submit', function (e) {
        ...
        var weightValue = updateForm.querySelector('#weight-value-update');
